#ifndef LUISA_DETECTOR_23_HPP
#define LUISA_DETECTOR_23_HPP
...
/**
 * \class LuisaDetector23
 * @brief Implements Luisa's shock detector
 */

class LuisaDetector23 : public LuisaDetector {
public:
    LuisaDetector23(double sensitivity_in, int nPointsI_in, int nPointsJ_in);
